        ...
        <Wrapper>
            ...
            <Content>
                ...
                transition={{ 
                    ...
                    duration:2,
                    default: { ease: "linear" }
                }}>Somos cuatro jóvenes apasionados por la cultura y la tecnología, buscamos crear un impacto en el desarrollo cultural, turístico y ecónomico de la región. 
                No dudes en escribirnos si tienes alguna duda, sugerencia o mensaje para nosotros.</motion.p>
                <button onClick={() =>navigate('/inicio')}>Contactanos</button>
            </Content>
        </Wrapper>
