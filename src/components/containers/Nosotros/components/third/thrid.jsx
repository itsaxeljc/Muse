    ...
    return (
        <Wrapper>
            <Artist className="collage">
                <img className={styles.coverArtist} id={styles.position} alt="Artista portada" src={Artista1}></img>
                <img className={styles.artist1} id={styles.position} alt="Artista 2" src={Artista2}></img>
                <img className={styles.artist2} id={styles.position} alt="Artista 3" src={Artista3}></img>
                <img className={styles.artist3} id={styles.position} alt="Artista 4" src={Artista4}></img>
                <img className={styles.artist4} id={styles.position} alt="Artista 5" src={Artista5}></img>
            </Artist>
            <Content>
                <motion.h1 
                initial={{
                ...
                transition={{ 
                    ...
                    duration:2,
                    default: { ease: "linear" }
                }}>Una nueva generación de artesanos. Somos un movimiento que forja la bases de la transformación cultural. Un paso hacia la preservación de las culturas populares y el apoyo a los artistas independientes.</motion.p>
            </Content>
        </Wrapper>
